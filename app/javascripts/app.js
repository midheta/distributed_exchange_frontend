...
window.App = {
    ...
    withdrawToken: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            return exchangeInstance.withdrawToken(nameToken, amountTokens, {from: account, gas: 4500000});
        }).then(function () {
    ...
    updateOrderBooks: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            for (var i = 0; i < buyOrderBook[0].length; i++) {
                document.getElementById("buyOrderBook").innerHTML += '<div>buy ' + buyOrderBook[1][i] + '@' + buyOrderBook[0][i] + '</div>'; //sell 650@5000: sell 650 token for 5000 wei.
            }
        }).catch(function (e) {
            console.log(e);
            App.setStatus("Error getting balance; see log.");
