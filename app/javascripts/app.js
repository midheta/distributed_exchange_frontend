...
//buy token
    ...
    allowanceToken: function () {
        ...
        var amount = parseInt(document.getElementById("amountInToken").value);
        var allowedAddress = document.getElementById("allowanceToAddress").value;
        ...
        return TokenContract.deployed().then(function (instance) {
            tokenInstance = instance;
            return tokenInstance.approve(allowedAddress, amount, {from: account});
        }).then(function () {
            App.setStatus("Transaction complete!");
            App.updateTokenBalance();
